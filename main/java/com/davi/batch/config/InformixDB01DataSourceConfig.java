...
@Configuration
@ConfigurationProperties("spring.informix.db01.datasource")
@MapperScan(
	basePackages = "com.davi.batch.mapper.informix.db01", 
	sqlSessionFactoryRef = InformixDB01DataSourceConfig.SQL_SESSION_FACTORY_NAME)
public class InformixDB01DataSourceConfig {
	...
	public DataSource informixDb02DataSource() throws SQLException {
		...
		config.setPoolName("POOL-IFXDB01");
	...
	@Bean(name = InformixDB01DataSourceConfig.SQL_SESSION_FACTORY_NAME)
